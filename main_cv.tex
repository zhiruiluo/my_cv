...
\newcommand{\printpublication}[1]{\AtNextCite{\defcounter{maxnames}{99}}\printpublication{#1}}
...
\begin{document}
    ...
    \begin{tablist}
        \item[2022] \tab{}\printpublication{li2022new}
        \item[2022] \tab{}\printpublication{qi2022novel} 
        \item[2021] \tab{}\printpublication{luo2021deep}
        \item[2021] \tab{}\printpublication{luo2021study}
        \item[2018] \tab{}\printpublication{zamani2018patterns}
        \item[2015] \tab{}\printpublication{li2015research}
    \end{tablist}

    \subsection*{Conference Proceedings}
    \begin{tablist}
        \item[2022] \tab{}\printpublication{luo2022abode-net}
        \item[2021] \tab{}\printpublication{li2021deep}
    \end{tablist}
