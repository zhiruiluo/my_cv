...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[2018-2022] \tab{}Teaching Assistant
    \end{tablist}
    ...
    \begin{tablist}
        \item[2018-2020] Research assistant on privacy and intrusion detection 
        \item[2017] Research assistant on optimization method of the twice-differetiable non-convex function
        \item[2016-2017] Robotics Lab Research, NMT
    \end{tablist}
